...
<style>
    ...
    .icon-total    { background: #fff1f2; }
    .icon-pendente { background: #fdf2f8; }
    .icon-rota     { background: #fdf4ff; }
    .icon-entregue { background: #ecfdf5; }
    ...
    .fill-total    { background: linear-gradient(90deg, #fb7185, #ec4899); }
    .fill-pendente { background: linear-gradient(90deg, #f472b6, #d946ef); }
    .fill-rota     { background: linear-gradient(90deg, #e879f9, #f472b6); }
    .fill-entregue { background: linear-gradient(90deg, #34d399, #14b8a6); }
    ...
    .badge-em-rota           { background: #fdf4ff; color: #a21caf; }
    .badge-em-rota::before   { background: #d946ef; }
    ...
    .empty-title  { color: #6b7280; font-weight: 600; margin-bottom: 4px; font-size: 15px; }
    .empty-text   { color: #9ca3af; font-size: 13px; margin-bottom: 18px; }
    ...
    @media (max-width: 640px) {
        ...
        .dashboard-table th,
        .dashboard-table td { padding: 12px 16px; }
    }
</style>
...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-bar"><div class="stat-bar-fill fill-total" style="width:100%"></div></div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-bar"><div class="stat-bar-fill fill-pendente" style="width:{{ $pct($pendente) }}%"></div></div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-bar"><div class="stat-bar-fill fill-rota" style="width:{{ $pct($em_rota) }}%"></div></div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-bar"><div class="stat-bar-fill fill-entregue" style="width:{{ $pct($entregue) }}%"></div></div>
    </div>
